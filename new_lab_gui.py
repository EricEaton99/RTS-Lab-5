...
def lab1():
    ...
    os.chdir('/home/pi/Desktop/CEG4166/Lab1/')
...
def lab2_part1():
    os.system('sudo killall pigpiod')
    os.system('sudo pigpiod')
    os.chdir('/home/pi/Desktop/CEG4166/Lab2/')
...
def lab2_part3():
    ...
    os.system('sudo pigpiod')
    os.chdir('/home/pi/Desktop/CEG4166/Lab2/')
    os.system('python3 lab2_keyboard.py')

def lab3_1():
    os.system('sudo killall pigpiod')
    os.system('sudo pigpiod')
    os.chdir('/home/pi/Desktop/CEG4166/Lab3/')
...
def lab4_a():
    ...
    os.system('sudo killall pigpiod')
    os.chdir('/home/pi/Desktop/CEG4166/Lab4/')
...
def lab5():
    os.system('sudo killall pigpiod')
    os.system('sudo pigpiod')
    os.chdir('/home/pi/Desktop/CEG4166/Lab5/')
...
btn2_b = Button(window, text="Sonar Control", bg="cyan", fg="black",command=lab2_part2)
btn2_b.grid(column=2, row=1, sticky='ew')

btn2_c = Button(window, text="Keyboard Control", bg="yellow", fg="black",command=lab2_part3)
btn2_c.grid(column=3, row=1, sticky='ew')

###lab3
btn3_b = Button(window, text="Plot Sonar Graph", bg="cyan", fg="black",command=lab3_2)
btn3_b.grid(column=1, row=2, sticky='ew')

btn3_a = Button(window, text="Object Detection", bg="orange", fg="black",command=lab3_1)
...
btn6 = Button(window, text="Stop", bg="red", fg="black",command=stop)
btn6.grid(column=2, row=8,   sticky='ew')
